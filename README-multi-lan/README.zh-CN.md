...
| **一键召回** | 在 ChatGPT 输入框旁点击 Recall 按钮，自动注入相关记忆作为 RAG 上下文 |
...
**支持平台：** ChatGPT（`chat.openai.com` / `chatgpt.com`）· Gemini（`gemini.google.com`）· Claude — _开发中_
